...
public class Utility {
    ...
    public static boolean isMetric(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getString(context.getString(R.string.prefs_temperature_key),
                context.getString(R.string.prefs_temperature_metric))
                .equals(context.getString(R.string.prefs_temperature_metric));
    }
